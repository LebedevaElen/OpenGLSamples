...
namespace Sample2_Uniforms
{
    public partial class MainForm : Form
    {
        ...
        private void Render()
        {
            ...
            int location = GL.GetUniformLocation(shaderProgram, "RotationMatrix");
            if (location >= 0) GL.UniformMatrix4(location, false, ref rotation);
        ...
        private int CreateShaderProgram()
        {
            ...
            // get source code
            string vertex_shader_source = Sample2_Uniforms.Properties.Resources.basic_vert;
            string fragment_shader_source = Sample2_Uniforms.Properties.Resources.basic_frag;
